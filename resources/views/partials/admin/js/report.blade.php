    ...
    <script>
        ...
        function showDetailSwal(userId, userName) {
            Swal.fire({
                title: `Detail Absensi: ${userName}`,
                html: '<div id="swal-detail-body">Memuat data...</div>',
                width: '80%',
                showCloseButton: true,
                showConfirmButton: false,
                didOpen: () => {
                    fetch(`/admin/laporan/${userId}/detail-ajax`)
                        .then(res => res.text())
                        .then(html => {
                            document.getElementById('swal-detail-body').innerHTML = html;
                        }).catch(() => {
                            document.getElementById('swal-detail-body').innerHTML =
