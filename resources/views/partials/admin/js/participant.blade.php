    ...
    <script>
        ...
        function showTambahPeserta() {
            Swal.fire({
                title: 'Tambah Peserta',
                html: `
                @php
                    $labelMap = collect($form)->pluck(0, 2); // ['student_number' => 'Nomor Peserta']
                @endphp
        ...
        function showEditPeserta(id, data) {
            const form = @json($form); // [['Nama Peserta', 'text', 'name'], ...]
