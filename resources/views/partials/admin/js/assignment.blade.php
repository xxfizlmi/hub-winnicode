    ...
    <script>
        ...
        function assignment(participantId) {
        const select = document.getElementById(`mentor_${participantId}`);
        ...
        fetch(`/admin/penugasan/${participantId}`, {
                method: 'POST',
                headers: {
            ...
            .catch(() => {
                Swal.close();
                Swal.fire('Gagal', 'Gagal menyimpan pembimbing.', 'error');
            });
    }
    </script>
