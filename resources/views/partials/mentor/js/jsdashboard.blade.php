        ...
        .then(data => {
            ...
            new Chart(document.getElementById('weeklyBarChart'), {
                ...
                data: {
                    ...
                    datasets: [
                        { label: 'Hadir', data: data.map(d => d.present), backgroundColor: '#14b8a6' },
                        { label: 'Izin', data: data.map(d => d.excused), backgroundColor: '#60a5fa' },
                        { label: 'Sakit', data: data.map(d => d.sick), backgroundColor: '#facc15' },
                        { label: 'Alfa', data: data.map(d => d.absent), backgroundColor: '#f87171' },
                    ]
                },
                options: {
                    responsive: true,
